...
export function AppearanceSettings() {
  ...
  // Debug: Log settings to see if new properties exist
  useEffect(() => {
    // Settings loaded
  }, [settings])
  ...
  useEffect(() => {
    ...
    applyAppearanceChanges('appearance.theme', settings.appearance.theme)
    applyAppearanceChanges('appearance.fontSize', settings.appearance.fontSize)
    applyAppearanceChanges('appearance.animationsEnabled', settings.appearance.animationsEnabled)
  }, [])
      ...
      <section className="space-y-0">
        ...
        <div className="space-y-0">
          <SettingSegmentedControl
            ...
            onChange={(value) => updateSetting('appearance.sidebarPosition', value)}
          />
          ...
          <SettingSegmentedControl
            ...
            options={POSITION_OPTIONS}
            onChange={(value) => updateSetting('appearance.chatPosition', value)}
          />
        </div>
      </section>
      ...
      <section className="space-y-0">
        ...
        <div className="space-y-0">
          <SettingSelect
            ...
            onChange={(value) => updateSetting('appearance.codeTheme', value)}
          />
          ...
          <SettingToggle
            ...
            onChange={(value) => updateSetting('appearance.showLineNumbers', value)}
          />
        </div>
      </section>
