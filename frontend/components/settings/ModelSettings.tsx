...
export function ModelSettings({ isVisible = true }: ModelSettingsProps) {
  ...
  useEffect(() => {
    const loadUsageData = async () => {
      ...
      try {
        ...
        const initialStats = await fetchUsageStats(user.id, {
  ...
  const handleImportModels = async () => {
    ...
    try {
      ...
      updateSetting('models.configuredModels', updatedModels)
  ...
  const handleDeleteModel = (modelId: string) => {
    ...
    if (settings.models.defaultModel === modelId) {
      updateSetting('models.defaultModel', updatedModels[0]?.id || '')
    }
  ...
  const handleSetDefault = (modelId: string) => {
    updateSetting('models.defaultModel', modelId)
            ...
            <div className="w-96 flex-shrink-0 border-r border-zinc-800 pr-4">
              ...
              <div className="space-y-4 p-6 bg-zinc-900/50 rounded-lg border border-zinc-800">
                ...
                <Button
                  ...
                  disabled={isFetching || !newApiKey.trim()}
